...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'odbc' => [
            'driver'   => 'odbc',
            'dsn'      => env('DB_SYBASE_DSN'),
            'host'     => env('DB_SYBASE_HOST'),
            'port'     => env('DB_SYBASE_PORT_'),
            'database' => env('DB_SYBASE_DATABASE'),
            'username' => env('DB_SYBASE_USERNAME'),
            'password' => env('DB_SYBASE_PASSWORD'),
            // 'options'  => [
